...
Source Database       : adopt

Target Server Type    : MYSQL
Target Server Version : 50726
File Encoding         : 65001

Date: 2022-07-03 20:06:00
*/
...
CREATE TABLE `chongwufenlei` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fenlei` (`fenlei`) USING BTREE
...
INSERT INTO `chongwufenlei` VALUES ('1610762157887', '2021-01-16 09:55:57', '这里添加宠物分类');
...
-- ----------------------------
INSERT INTO `chongwuyongpin` VALUES ('31', '2021-01-16 09:02:43', '商品名称1', '衣服饰品', 'http://localhost:8080/ssmqj7b0/upload/chongwuyongpin_tupian1.jpg', '双', '品牌1', '保质期1', '<p>商品详情1</p>', '2021-01-20', '2021-01-16 10:02:12', '8', '22');
INSERT INTO `chongwuyongpin` VALUES ('32', '2021-01-16 09:02:43', '商品名称2', '衣服饰品', 'http://localhost:8080/ssmqj7b0/upload/chongwuyongpin_tupian2.jpg', '规格2', '品牌2', '保质期2', '<p>商品详情2</p>', '2020-12-27', '2021-01-16 10:02:09', '7', '20');
...
INSERT INTO `forum` VALUES ('1610762036807', '2021-01-16 09:53:56', null, '这里可以评论其他用户发布的交流帖子', '1610761476912', '1610761656144', '666', null);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES ('1', '1', 'abo', 'users', '管理员', 't0mbr9k8y5o9v4xk5phall7jusm0wwoh', '2021-01-16 09:35:50', '2022-07-03 21:05:13');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'abo', 'abo', '管理员', '2021-01-16 09:02:43');
