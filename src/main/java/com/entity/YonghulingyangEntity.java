...
public class YonghulingyangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YonghulingyangEntity() {
		
	}
	
	public YonghulingyangEntity(T t) {
		try {
	 ...
	 * 设置：领养标题
	 */
	public void setLingyangbiaoti(String lingyangbiaoti) {
		this.lingyangbiaoti = lingyangbiaoti;
	}
	/**
	 * 获取：领养标题
	 */
	public String getLingyangbiaoti() {
		return lingyangbiaoti;
	}
	/**
	 * 设置：宠物名称
	 */
